...
export default function MedicalCertificateUploader() {
    ...
    const uploadFile = (file: File | Blob, source: string) => {
        ...
        formData.append('image', file, file instanceof File ? file.name : `medical-certificate-${Date.now()}.png`);
        formData.append('source', source);
        router.post('/medical-certificates', formData, {
            forceFormData: true,
            ...
            {stage === 'uploading' && (
                <div className="flex items-center justify-center h-64">
                    <div className="text-center">
                        ...
                        <p className="mt-3 text-sm text-[var(--color-text-secondary)]">Uploading medical certificate...</p>
                    ...
                    {activeTab === 'upload' && (
                        ...
                        >
                            ...
                            <p className="mt-4 text-sm text-[var(--color-text-secondary)]">
                                {isDragActive ? 'Drop your medical certificate here' : 'Drag & drop your medical certificate, or click to browse'}
                            </p>
